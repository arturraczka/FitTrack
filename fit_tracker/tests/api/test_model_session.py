...
def test_create_session_model(user_instance):
    session_type = 'running'
    summary_instance = Summary.objects.get(user=user_instance , summary_type=session_type)
    test_session = Session(user=user_instance , summary=summary_instance , session_type=session_type ,
                           distance=10 , intensity='medium' , length_time='01:00:00' ,
                           session_date='2023-05-13T07:32:38')
    test_session.clean()
    test_session.save()
    assert test_session.user == user_instance
...
@pytest.mark.django_db
def test_validation_error_triggering_session_model(user_instance):
    session_type = 'running'
    summary_type = 'hiking'
    summary_instance = Summary.objects.get(user=user_instance , summary_type=summary_type)
    test_session = Session(user=user_instance , summary=summary_instance , session_type=session_type ,
                           distance=10 , intensity='medium' , length_time='01:00:00' ,
                           session_date='2023-05-13T07:32:38')
...
@pytest.mark.django_db
def test_delete_session_model(user_instance):
    session_type = 'running'
    summary_instance = Summary.objects.get(user=user_instance , summary_type=session_type)
    test_session = Session(user=user_instance , summary=summary_instance , session_type=session_type ,
                           distance=10 , intensity='medium' , length_time='01:00:00' ,
...
@pytest.mark.django_db
def test_get_session_model(user_instance):
...
@pytest.mark.django_db
def test_invalid_update_session_model(user_instance):
    session_type = 'hiking'
    summary_instance = Summary.objects.get(user=user_instance , summary_type=session_type)
    test_session = Session(user=user_instance , summary=summary_instance , session_type=session_type ,
                           distance=10 , intensity='medium' , length_time='01:00:00' ,
...
@pytest.mark.django_db
def test_update_session_model(user_instance):
    session_type = 'hiking'
    summary_instance = Summary.objects.get(user=user_instance , summary_type=session_type)
    test_session = Session(user=user_instance , summary=summary_instance , session_type=session_type ,
                           distance=10 , intensity='medium' , length_time='01:00:00' ,
