...
def test_create_summary_model(user_instance):
    test_summary = Summary.objects.create(user=user_instance, summary_type= 'running', total_distance=50,
                                          total_number_sessions=5, average_length_time='05:00:00',
                                          last_session='2023-05-13T07:32:38')

    assert test_summary.user == user_instance
